...
def get_notes():
	...
	with open('/Users/ndivhuwonyase/Desktop/Keras-LSTM-Music-Generator/data/notes', 'wb') as filepath:
		pickle.dump(notes, filepath)
	
	with open('/Users/ndivhuwonyase/Desktop/Keras-LSTM-Music-Generator/data/durations', 'wb') as filepath:
		pickle.dump(durations, filepath)
		
	with open('/Users/ndivhuwonyase/Desktop/Keras-LSTM-Music-Generator/data/offsets', 'wb') as filepath:
